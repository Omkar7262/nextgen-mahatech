...
export default function About() {
  const [content, setContent] = useState<any>({
    title: "About NextGen MahaTech",
    description: "NextGen MahaTech is a technology-driven software company specializing in Association Management Systems. We help associations and organizations streamline their operations through smart mobile applications, powerful admin dashboards, and cloud-based digital solutions.",
  });
    ...
    fetch("/api/content/about")
      ...
      .then(data => {
        if (data.success && data.data.about) {
          setContent({
            title: data.data.about.title || content.title,
            description: data.data.about.description || content.description,
          });
        }
      });
  }, []);
      ...
      <div className="relative mx-auto max-w-7xl px-5 md:px-8">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <div className="relative">
            <div className="grid grid-cols-2 gap-6" style={{ perspective: 1400 }}>
              <div className="space-y-6">
                <motion.div {...reveal({ rotateX: 35 })}>
                  <div className="group relative flex aspect-square flex-col justify-between rounded-[2.5rem] p-8 text-white overflow-hidden shadow-2xl shadow-indigo-500/20">
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-600 via-indigo-700 to-blue-800 transition-transform duration-500 group-hover:scale-110" />
                    <div className="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]" />
                    <div className="relative z-10">
                      <div className="h-12 w-12 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center mb-6">
                        <svg className="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                          <circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" />
                        </svg>
                      </div>
                      <div className="text-4xl font-black tracking-tight">10+</div>
                      <div className="text-sm font-bold text-indigo-100 mt-2 uppercase tracking-widest">Years Expertise</div>
                    </div>
                  </div>
                </motion.div>
                
                <motion.div {...reveal({ rotateX: 35 }, 0.12)}>
                  <div className="group relative flex aspect-[4/3] flex-col justify-between rounded-[2rem] bg-white p-8 overflow-hidden shadow-xl border border-slate-100 transition-all duration-500 hover:border-emerald-200">
                    ...
                    <div className="relative z-10">
                      <svg className="h-10 w-10 text-emerald-600 mb-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                        <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><path d="M22 4 12 14.01l-3-3" />
                      </svg>
                      <div className="text-3xl font-black text-slate-900 tracking-tight">98%</div>
                      <div className="text-sm font-bold text-slate-500 mt-1 uppercase tracking-widest">Client Retention</div>
                    </div>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="space-y-6 pt-12">
                <motion.div {...reveal({ rotateY: 60 })}>
                  <div className="group relative flex aspect-[4/3] flex-col justify-between rounded-[2rem] bg-slate-900 p-8 text-white overflow-hidden shadow-2xl transition-all duration-500">
                    ...
                    <div className="relative z-10">
                      <div className="h-12 w-12 rounded-2xl bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center mb-6">
                      ...
                      <div className="text-2xl font-black tracking-tight">Full-Stack</div>
                      <div className="text-sm font-bold text-slate-400 mt-1 uppercase tracking-widest">Engineering</div>
                    </div>
                  </div>
                </motion.div>

                <motion.div {...reveal({ rotateY: -45, scale: 0.8 }, 0.1)}>
                  <div className="group relative flex aspect-square flex-col justify-between rounded-[2.5rem] p-8 text-white overflow-hidden shadow-2xl shadow-cyan-500/20">
                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-500 to-teal-600 transition-transform duration-500 group-hover:scale-110" />
                    <div className="relative z-10">
                      <div className="h-12 w-12 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center mb-6">
                        <svg className="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <div className="text-4xl font-black tracking-tight">150+</div>
                      <div className="text-sm font-bold text-cyan-50 mt-2 uppercase tracking-widest">Deliveries</div>
                    </div>
                  </div>
                </motion.div>
              </div>
